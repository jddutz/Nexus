...
public partial class PerspectiveCamera : Component, ICamera
{
    ...
    private unsafe void InitializeViewProjectionUBO()
    {
        ...
        _viewProjectionDescriptorLayout = _descriptorManager.CreateDescriptorSetLayout([
            layoutBinding,
        ]);

        // Allocate descriptor set
        _viewProjectionDescriptorSet = _descriptorManager.AllocateDescriptorSet(
            _viewProjectionDescriptorLayout
        );
        ...
        _graphicsContext.VulkanApi.UpdateDescriptorSets(
