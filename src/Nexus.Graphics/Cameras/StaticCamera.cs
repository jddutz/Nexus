...
public partial class StaticCamera : Component, ICamera
{
    ...
    private unsafe void InitializeViewProjectionUBO()
    {
        ...
        ).DescriptorManager.CreateDescriptorSetLayout([layoutBinding]);

        // Allocate descriptor set
        _viewProjectionDescriptorSet = (
            (GraphicsSystem)Graphics
        ).DescriptorManager.AllocateDescriptorSet(_viewProjectionDescriptorLayout);
