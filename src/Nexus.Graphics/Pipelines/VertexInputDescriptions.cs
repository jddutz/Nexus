...
public static class VertexInputDescriptions
{
    ...
    /// </summary>
    public static VertexInputDescription Position2D { get; } =
        new()
        {
            Bindings =
            [
    ...
    /// </summary>
    public static VertexInputDescription Position2DColor { get; } =
        new()
        {
            Bindings =
            [
    ...
    /// </summary>
    public static VertexInputDescription Position2DTexCoord { get; } =
        new()
        {
            Bindings =
            [
